...
const homework_weight = (0.15*first_homework + 0.15*second_homework + 0.15*third_homework)/3;
const quiz_weight = (0.35*first_quiz + 0.35*second_quiz + 0.35*third_quiz)/3;
const test_weight = (0.5*first_test + 0.5*second_test + 0.5*third_test)/3;
